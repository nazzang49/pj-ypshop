...
// if(accessToken!=null){
// 	System.out.print("액세스 토큰 : " +accessToken);
// }
...
if(code!=null){
    ...
    String clientSecret = "QA2KLYBNXB4O7LTTKSMSGAY2D5IPABXG";//애플리케이션 클라이언트 시크릿값";
    String redirectURI = "http://localhost:8090/ypshop-frontend/admin";
    ...
    try {
      ...
      if(responseCode==200) {
    	...
    	System.out.print("액세스 토큰 : "+access_token);
...
%>
<a href="<%=apiURL%>">솔라피 메시지 액세스 토큰 받기</a>


솔라피 문자 발송 api 테스트 :
<form action="${pageContext.request.contextPath}/admin/sms/test" method="post">
<input type="text" name="text" id="sms"><button type="submit" id="sms-send" class="btn btn-info">문자 발송</button>
...
<% 
 ...
 %>
<a href="<%=uri%>">솔라피 메시지 액세스 토큰 받기</a>
