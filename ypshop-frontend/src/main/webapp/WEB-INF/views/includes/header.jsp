...
<header class="header">
    <div class="container-fluid px-lg-5">
        <nav class="py-4">
            <div id="logo">
                <h1><a href="${pageContext.servletContext.contextPath}">CAFE24</a></h1>
            </div>
            ...
            <ul class="menu mt-2">
            	...
            	<c:when test="${param.menu == 'main' }">
            	    ...
            	    <li><a href="${pageContext.servletContext.contextPath}/member/info/<sec:authentication property="principal.username"/>">회원정보</a></li>
            	    <li><a href="${pageContext.servletContext.contextPath}/member/mypage/<sec:authentication property="principal.username"/>">마이페이지</a></li>
	            ...
	            <c:when test="${param.menu == 'info' }">
            		<li><a href="${pageContext.servletContext.contextPath}">메인</a></li>
            	    <sec:authorize access="isAuthenticated()">
            	    <li class="active"><a href="${pageContext.servletContext.contextPath}/member/info/<sec:authentication property="principal.username"/>">회원정보</a></li>
            	    <li><a href="${pageContext.servletContext.contextPath}/member/mypage/<sec:authentication property="principal.username"/>">마이페이지</a></li>
	                <li><a href="${pageContext.servletContext.contextPath}/member/logout">로그아웃</a></li>
	                </sec:authorize>
	                <sec:authorize access="!isAuthenticated()">
